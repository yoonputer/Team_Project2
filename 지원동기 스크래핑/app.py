...
for i in range(1, 140):
    makingurl = f'https://www.jobkorea.co.kr/starter/PassAssay?FavorCo_Stat=0&Pass_An_Stat=1&schTxt=%EC%A7%80%EC%9B%90&OrderBy=0&EduType=0&WorkType=0&isSaved=0&Page={i}'
